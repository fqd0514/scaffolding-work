...
public class RedisConfig extends CachingConfigurerSupport {
     ...
     */
    @Bean
    public KeyGenerator keyGeneratorOnSameMinute() {
...
//        RedisCacheConfiguration defaultCacheConfig = RedisCacheConfiguration.defaultCacheConfig();
    ...
    @Bean(name = "noTransactionRedisTemplate", value = "noTransactionRedisTemplate")
    public RedisTemplate<String,Object> noTransactionRedisTemplate(RedisConnectionFactory redisConnectionFactory){
        RedisTemplate<String, Object> redisTemplate = new RedisTemplate<>();
