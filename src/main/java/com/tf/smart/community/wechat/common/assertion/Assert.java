package com.tf.smart.community.wechat.common.assertion;
...
public interface Assert {
     ...
     * @return
     */
    CommonBusinessException newException(Object... args);
     ...
     * @return
     */
    CommonBusinessException newException(Throwable t, Object... args);
     ...
     * @param o2  待判断对象
     */
    default void assertContain(String o1, String o2) {
        if (o1.contains(o2)) {
            return;
        }
        if (o1 == null) {
